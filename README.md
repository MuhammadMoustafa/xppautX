...
3. **New front end.** Menus and hotkeys come from the menu tables in
   ...
   2. *(in progress: `graf_par.c` done)* Move the command handlers that still live in X11 files (the
...
| Script | Measures | Now |
|---|---|---|
| `tools/x11free.sh` | sources that compile with X11 headers stubbed out | 85 / 111 |
