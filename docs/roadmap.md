...
| W27a | #43 | C to C++, CVODE and its linear algebra, together (llnltyps.h's bool macro: CLAUDE.md): cv2, cvode, cvband, cvdense, band, dense, llnlmath, vector | none | running |
