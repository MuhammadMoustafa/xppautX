...
| W6  | #18 | New UI: the views | W5 | running (T18 left; T2-T17, T19 done) |
...
| W11 | - | One I/O module: logging only, safe formatting, file reading and writing | none (step 3 with W7) | running (step 1 done; step 2 next) |
